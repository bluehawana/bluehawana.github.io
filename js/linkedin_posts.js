    ...
    try {
        ...
        if (postsContainer && posts && Array.isArray(posts) && posts.length > 0) {
            ...
            for (let i = 0; i < postsToShow.length; i++) {
                ...
                postElement.className = 'linkedin-post-card';
                ...
                // Create engagement stats container
                const bbsStats = `
                    <div class="engagement-stats-bbs">
                        <div class="stats-header">╔═══ ENGAGEMENT STATS ═══╗</div>
                        <div class="stats-grid">
                            <span>👍 Likes: <span class="stat-value">${engagementStats.likes}</span></span>
                            <span>💬 Comments: <span class="stat-value">${engagementStats.comments}</span></span>
                            <span>🔄 Shares: <span class="stat-value">${engagementStats.shares}</span></span>
                        </div>
